...
import com.demo.test.CheckSumBuilder;
public class MobileMessageCheck {
	 private static final String SERVER_URL="https://api.netease.im/sms/verifycode.action";//校验验证码的请求路径URL
	    private static final String APP_KEY="ae55f9f19e6623f378d2c8fd0ad3cdd4";//账号
	    private static final String APP_SECRET="0a202874d511";//密钥
