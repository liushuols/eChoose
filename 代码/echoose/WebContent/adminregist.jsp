...
<head>
	...
	<style type="text/css">
		#register{height:450px;width:500px;}
		.vali input{width:100%;height:40px;}
		.vali1{margin-top:100px;}
	...
	<div class="body">
		<div class="vli">
			<div class="wrapper move">
				<div id="register">
					<form class="form2" method="post" action="administor/saveadministor" >
						<h3>易选择网管理员注册</h3>
						
						<div class="vali">
							<input type="text" name="aname"  placeholder="请输入用户名" id="username" class="input_class" onblur="checkUsername(this)" /><span id="username_span"></span>
						</div>
						<div class="vali">
							<input type="password"  name="apassword" placeholder="请填写长度至少为8个字符的密码" id="password" class="input_class" onblur="checkPassword(this)" /><span id="password_span">请输入8-12位密码</span>
						</div>
						<div class="vali">
